...
function writeProfileUrlUnion({ fhirType, constName, typeName, outPath, sourceNote }) {
  ...
  const lines = [
    '// Auto-generated by scripts/copy-fhir.mjs — do not edit by hand.',
    `// Source: ${sourceNote}`,
 ...
 * in ig/input/resources/questionnaires/.
 *
...
function writeInstrumentItemCodes() {
  ...
  const lines = [
    '// Auto-generated by scripts/copy-fhir.mjs — do not edit by hand.',
    '// Source: ig/input/resources/questionnaires/<tool>/*.json (Questionnaire.item[].code), keyed by',
 ...
 * options that Questionnaire item declares`, read out of ig/input/resources/questionnaires/.
 *
 ...
 * `ig/input/resources/questionnaires/` is already inside the manifest's input fingerprint, so
...
function writeQuestionnaireOrdinals() {
  ...
  const lines = [
    '// Auto-generated by scripts/copy-fhir.mjs — do not edit by hand.',
    '// Source: ig/input/resources/questionnaires/<tool>/*.json (Questionnaire.item[].answerOption with',
 ...
 * equal the canonical's last segment (CLAUDE.md, `ig/input/resources/questionnaires/`), so the key
...
function writeQuestionnaireUrls() {
  ...
  const lines = [
    '// Auto-generated by scripts/copy-fhir.mjs — do not edit by hand.',
    '// Source: ig/input/resources/questionnaires/<tool>/*.json (Questionnaire.id → Questionnaire.url).',
    '// Regenerated on every `npm run copy-fhir` (also runs as predev / prebuild).',
    '//',
 ...
 * `hashFiles('ig/input/fsh/**', 'ig/input/resources/questionnaires/**', …)` in the workflow would
