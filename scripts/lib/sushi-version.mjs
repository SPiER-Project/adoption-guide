 ...
 * `package.json` devDependency, so `npx` found the locked local copy in
 * `node_modules/.bin` before ever considering the registry. It no longer
 * is one (E2b, docs/plans/repo-and-package-boundaries.md §9.7), so the version
 * has to be named explicitly wherever sushi is invoked — `scripts/copy-fhir.mjs`
