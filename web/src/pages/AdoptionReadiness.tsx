  ...
  return (
    <div className="adoption-readiness">
      ...
      <p className="ar-description">
        ...
        <Link to="/implementation-guide/adoption-rubric">EHR Adoption Rubric</Link>, where you score your
        own system.
      </p>
                  ...
                  <tr key={tool.id}>
                    ...
                    <td className="ar-col-resources">
                      <div className="ar-resources">
                        {tool.pilotPlanSlug && (
                          <Link className="ar-res-link" to={`/implementation-guide/pathway/${tool.pilotPlanSlug}/plan`}>
                            Pilot plan
                          </Link>
                        )}
      ...
      <section className="ar-crosslinks">
        ...
        <ul className="ar-crosslinks-list">
          <li>
            <Link to="/implementation-guide/roadmap">Roadmap</Link> — the build status above, by tool, with
            tracking epics and the three strategic priorities behind them.
          </li>
          <li>
            <Link to="/implementation-guide/pathway">Pathway</Link> — each instrument in its clinical
            context across the 8-stage Suicide Safer Care pathway.
          </li>
          <li>
            <Link to="/implementation-guide/adoption-rubric">EHR Adoption Rubric</Link> — score your own
