...
export const DATA_ELEMENTS: DataElement[] = [
  ...
  },
  {
    ...
    code: 'suicide-plan',
    codeSystem: 'http://spier.org/CodeSystem/bssa-item',
    codeDisplay: 'Do you have a plan to kill yourself',
    fhirResource: 'Observation',
    fhirPath: 'valueCodeableConcept',
    usedBy: ['TL-005'],
  ...
  },
  {
    ...
    code: 'intent-scale',
    codeSystem: 'http://spier.org/CodeSystem/bssa-item',
    codeDisplay: 'On a scale from 0 to 10, how serious are you about killing yourself',
    fhirResource: 'Observation',
    fhirPath: 'valueInteger',
    usedBy: ['TL-005'],
  ...
  },
  {
    ...
    codeSystem: 'http://spier.org/CodeSystem/bssa-item',
    codeDisplay: 'Do you think you need help to keep yourself safe',
    fhirResource: 'Observation',
    fhirPath: 'valueCodeableConcept',
    usedBy: ['TL-005'],
