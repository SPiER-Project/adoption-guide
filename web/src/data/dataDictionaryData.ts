...
export const DATA_DICTIONARY: DataDictionaryEntry[] = [
  // ── C-SSRS ──
  {
    fieldName: 'C-SSRS Screener Panel',
    code: '93373-9',
    codeSystem: 'LOINC',
  ...
  {
    fieldName: 'Non-specific active suicidal thoughts',
    code: '93247-5',
    codeSystem: 'LOINC',
  ...
  {
    fieldName: 'Ideation with methods, no intent',
    code: '93248-3',
    codeSystem: 'LOINC',
  ...
  {
    fieldName: 'Ideation with some intent',
    code: '93249-1',
    codeSystem: 'LOINC',
  ...
  {
    fieldName: 'Ideation with specific plan and intent',
    code: '93250-9',
    codeSystem: 'LOINC',
  ...
  {
    fieldName: 'Suicidal behavior (ever)',
    code: '93267-3',
    codeSystem: 'LOINC',
  ...
  },
  {
    ...
    tool: 'C-SSRS',
    description: 'Derived risk level: Low (Q1-2), Moderate (Q3-4), High (Q5 or Q6+recent). Also used by CAMS.',
  },
  {
    fieldName: 'Actual lethality/medical damage',
    code: '93271-5',
    codeSystem: 'LOINC',
