...
see [`docs/best-practices/strategy-consent.md`](../../best-practices/strategy-consent.md)
and [`docs/best-practices/consent-vs-ds4p.md`](../../best-practices/consent-vs-ds4p.md).
