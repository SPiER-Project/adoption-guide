...
⚠️ **No status here has been verified against the rights holder's current published terms**, and four tools have no memo at all (PHQ-9, SBQ-R, CAMS, Stanley-Brown). [`docs/best-practices/licensing-verification-backlog.md`](../best-practices/licensing-verification-backlog.md) is the standing list of what is owed and of why a recorded notice is not a verification.
