...
| 11.4-1A | BH Clinician / Assessor | `QuestionnaireResponse` (C-SSRS Full + SAFE-T framing) | C-SSRS Full ([built](../../FHIR-Resources/C-SSRS/)); SAFE-T ([TL-006](https://github.com/bbthorson/SPiER/issues/22), status:planned, promote) | DC.1.7.1 Capture Standardized Assessments | n/a |
...
| 11.7-2A | EHR System / Follow-Up Protocol Manager | `Task` series (24–48h call, 7-day visit) + `PlanDefinition` (caring contacts cadence) + registry enrollment | **gap** — Caring Contacts PlanDefinition + Caring Contact Task profile ([TL-010](https://github.com/bbthorson/SPiER/issues/26), status:planned, promote) | DC.2.4.3 Care Plans Protocols; DC.2.4 Manage Care Plans | n/a |
