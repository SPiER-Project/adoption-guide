...
// node_modules, the same way its `fhirclient/*` path mapping does (see
...
// eslint-disable-next-line @typescript-eslint/triple-slash-reference -- see above: an `import` cannot reach it
